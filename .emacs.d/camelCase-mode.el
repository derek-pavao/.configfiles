...
;;
;; * camelCase-mode.el: Run (camelCase-install-mode) only once.
;;  Fixes forward-word, backward-word in subsequent
;;        non-camelCase buffers.
;;
;;* camelCase-mode.el: Apply patch by ivan4th.  Fixes
;;  "Wrong number of arguments" in Emacs 22.
;;
;; Keywords: camelCase camel case word mode
;; Tested on: Gnu Emacs 22.1, XEmacs 21.4
;;
...
(when (not (functionp 'camelCase-old-forward-word))
